    ...
    >
      ...
      >
        ...
        >
          <a
            href="#projects"
            className="group relative px-8 py-3 rounded-xl font-semibold text-sm transition-all duration-300 overflow-hidden"
            style={{
              background:
          ...
          <a
            href="#contact"
            className="px-8 py-3 rounded-xl font-semibold text-sm glass-panel-sm text-gray-300 hover:text-neon-blue hover:border-neon-blue/30 transition-all duration-300"
          >
            Contact Me
          </a>
        </motion.div>
